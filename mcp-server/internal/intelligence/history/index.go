...
import (
	...
	bm25 "github.com/hiromaily/claude-forge/mcp-server/pkg/search"
)
...
func resolveSpecsDir(specsDir string) string {
	...
	if ok {
		// filename is .../mcp-server/internal/intelligence/history/index.go;
		// go up five levels to reach the claude-forge repo root.
