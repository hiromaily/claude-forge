...
// These tests verify that RegisterAll accepts 13 parameters and registers 47 tools
...
// registers exactly 47 tools (set_task_type removed), including subscribe_events,
