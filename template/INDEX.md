...
| File | Referenced by |
| --- | --- |
| sections/ai/skills/docs-ssot.md | claude |
| sections/architecture/design-decisions.md | ARCHITECTURE, README |
| sections/architecture/directory-structure.md | ARCHITECTURE, CLAUDE, README |
...
| sections/development/go-module-setup.md | CLAUDE |
| sections/development/installation-guide.md | SETUP |
| sections/development/installation.md | README |
| sections/development/mcp-library-api.md | CLAUDE |
| sections/development/mcp-local-development.md | CLAUDE |
| sections/development/mcp-registration.md | CLAUDE |
| sections/development/running-tests.md | README |
| sections/development/script-conventions.md | CLAUDE |
| sections/development/setup-release.md | SETUP |
| sections/development/testing-plugin.md | CLAUDE |
| sections/product/feature-list.md | README |
| sections/product/flow-templates.md | README |
| sections/product/flow.md | README |
| sections/product/four-things-that-make-it-different.md | README |
| sections/product/human-interaction-points.md | README |
| sections/product/quick-start.md | README |
| sections/product/repository-workflow-rules-specs-instructions-md.md | README |
| sections/product/the-problem-with-sdd-today.md | README |
| sections/project/claude-forge-plugin-ai-agent-guide.md | CLAUDE |
| sections/project/claude-forge.md | README |
| sections/project/overview.md | README |

## Rules

| File | Referenced by |
| --- | --- |
| sections/ai/rules/docs.md | claude |
...
| File | Referenced by |
| --- | --- |
| sections/ai/commands/fix-pr-reviews.md | claude |

## Orphans

| File | Note |
| --- | --- |
| sections/agents/architect.md | Not referenced by any template |
| sections/agents/comprehensive-reviewer.md | Not referenced by any template |
| sections/agents/design-reviewer.md | Not referenced by any template |
| sections/agents/impl-reviewer.md | Not referenced by any template |
| sections/agents/implementer.md | Not referenced by any template |
| sections/agents/investigator.md | Not referenced by any template |
| sections/agents/overview.md | Not referenced by any template |
| sections/agents/situation-analyst.md | Not referenced by any template |
| sections/agents/task-decomposer.md | Not referenced by any template |
| sections/agents/task-reviewer.md | Not referenced by any template |
| sections/agents/verifier.md | Not referenced by any template |
| sections/architecture/concurrency.md | Not referenced by any template |
| sections/architecture/data-flow.md | Not referenced by any template |
| sections/architecture/design-principles.md | Not referenced by any template |
| sections/architecture/effort-flow.md | Not referenced by any template |
...
| sections/ja/agents/impl-reviewer.md | Not referenced by any template |
| sections/ja/agents/implementer.md | Not referenced by any template |
| sections/ja/agents/investigator.md | Not referenced by any template |
| sections/ja/agents/overview.md | Not referenced by any template |
| sections/ja/agents/situation-analyst.md | Not referenced by any template |
| sections/ja/agents/task-decomposer.md | Not referenced by any template |
| sections/ja/agents/task-reviewer.md | Not referenced by any template |
| sections/ja/agents/verifier.md | Not referenced by any template |
| sections/ja/architecture/concurrency.md | Not referenced by any template |
| sections/ja/architecture/data-flow.md | Not referenced by any template |
| sections/ja/architecture/design-principles.md | Not referenced by any template |
| sections/ja/architecture/directory-structure.md | Not referenced by any template |
| sections/ja/architecture/effort-flow.md | Not referenced by any template |
| sections/ja/architecture/go-package-layering.md | Not referenced by any template |
...
| sections/ja/project/introduction.md | Not referenced by any template |
| sections/ja/reference/cli-flags.md | Not referenced by any template |
...
| sections/project/introduction.md | Not referenced by any template |
| sections/reference/cli-flags.md | Not referenced by any template |
