<!-- SSOT: パイプラインのヒューマンインタラクションポイント（日本語版）。
     Included by:
       docs/ja/architecture/human-interaction.md
     このファイルのみを編集してください。内容変更時は英語版 docs/_partials/human-interaction-points.md も更新してください。
