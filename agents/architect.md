---
name: architect
description: Use this agent for Phase 3 (Design) of the dev-pipeline. Synthesizes analysis and investigation findings into a concrete design document covering approach, architecture changes, data model, test strategy, and risk mitigation.
model: sonnet
---
